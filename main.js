...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/a9uuaRhd0/model.json', modelLoaded);
...
function gotResult(error, results){
    if (error){
       ...
       if (results[0].label == "Shocked"){
        document.getElementById("emoji1").innerHTML = "&#58384";
       }
   ...
   if (results[0].label == "Shocked"){
    document.getElementById("emoji2").innerHTML = "&#58384";
   }
